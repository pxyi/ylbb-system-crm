<template>
  <div>
    ...
    <TableComponent url="/visit/memberVisitInfoList" :default="{visitType: 1}" ref="table" :auto="false">
      <el-table-column label="姓名" prop="name" width="80"></el-table-column>
      <el-table-column label="手机号" prop="mobilePhone" width="100"></el-table-column>
