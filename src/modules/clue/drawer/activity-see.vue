  ...
  <div>
    ...
    <TableComponent ref="table" url="/myClue/getNoVisitList" :default="{ visitId: activityInfo.id }">
      ...
      <el-table-column label="手机号" prop="mobilePhone" width="120">
        <template v-slot="scope">{{ scope.row.mobilePhone.substr(0, 3) + '****' + scope.row.mobilePhone.substr(7, 11) }}</template>
      </el-table-column>
      <el-table-column label="状态" prop="memberVisitStatusInfoForClue" width="80"></el-table-column>
    ...
    <el-drawer title="用户信息" size="960px" :destroy-on-close="true" :visible.sync="showPreview">
